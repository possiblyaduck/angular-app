...
module.exports = {
  mongo: {
    ...
    apiKey: 'enGIhyNHOOY-dgsVu8gYHqHqxb4MwAAj'                 // Our MongoLab API key
  },
  security: {
    dbName: 'groceries',                                   // The name of database that contains the security information
    usersCollection: 'groceries'                            // The name of the collection contains user information
  },
  server: {
